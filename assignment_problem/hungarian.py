...
https://blog.csdn.net/tommy0095/article/details/104466364
'''
import numpy as np
import collections
import time
...
class CoverZeros():
    ...
    def row_scan(self, marked_zeros):
        ...
        self._zero_locations_copy[:, row_indices[0]] = False
        self._zero_locations_copy[min_row_zero_nums[1], :] = False
    ...
    def calculate(self):
        ...
        # print(self._zero_locations_copy)
